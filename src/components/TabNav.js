...
const createLabel = (iconName, labelText) => (
  ...
  const panes = [
    ...
    {
      menuItem: ( 
        <Menu.Item key="characters" as={NavLink} to={`/characters`} content={characterLabel} />
      )
    },
    {
      menuItem: (
        <Menu.Item key="locations" as={NavLink} to={`/locations`} content={locationLabel} />
      )
    },
    {
      menuItem: (
        <Menu.Item key="episodes" as={NavLink} to={`/episodes`} content={episodesLabel} />
      )
    }
  ];
